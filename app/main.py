...
# --- DATABASE SETUP ---
sqlite_file_name = "database_sicuro.db" 
...
# --- ENDPOINT STAMPA (CALCOLA IL TOTALE SOLO QUI) ---
...
class PreventivoAdmin(ModelView, model=Preventivo):
    ...
    # RIMOSSO: after_model_change (il calcolo automatico che causava il crash)
