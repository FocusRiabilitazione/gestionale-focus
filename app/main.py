...
# --- FUNZIONI GRAFICHE (Fuori dalle classi per sicurezza) ---
...
class InventarioAdmin(ModelView, model=Inventario):
    ...
    column_formatters={Inventario.quantita: formatta_bottoni_magazzino}
...
def import_prestiti(l: List[PrestitoImport]):
    ...
    return {"msg": "Ok"}
@app.get("/")
def home(): return {"msg": "Gestionale Focus Rehab - Pulito e Funzionante"}
